...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[u_xlati1].yyy;
					    u_xlat4.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[u_xlati1].xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[u_xlati1].zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[u_xlati1].www + u_xlat4.xyz;
					    u_xlat2.x = dot(u_xlat4.xyz, in_NORMAL0.xyz);
					    u_xlat4.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].yyy;
					    u_xlat4.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].www + u_xlat4.xyz;
					    u_xlat2.y = dot(u_xlat4.xyz, in_NORMAL0.xyz);
					    u_xlat4.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].yyy;
					    u_xlat4.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].www + u_xlat4.xyz;
					    u_xlat2.z = dot(u_xlat4.xyz, in_NORMAL0.xyz);
					    u_xlat4.x = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat4.x = inversesqrt(u_xlat4.x);
					    vs_TEXCOORD0.xyz = u_xlat4.xxx * u_xlat2.xyz;
					    u_xlat3 = u_xlat0.y * unity_StereoMatrixV[(u_xlati1 + 1)].z;
					    u_xlat0.x = unity_StereoMatrixV[u_xlati1].z * u_xlat0.x + u_xlat3;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati1 + 2)].z * u_xlat0.z + u_xlat0.x;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati1 + 3)].z * u_xlat0.w + u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
					    vs_TEXCOORD0.w = (-u_xlat0.x);
					    return;
					}"
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[u_xlati1].yyy;
					    u_xlat2.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[u_xlati1].xxx + u_xlat2.xyz;
					    u_xlat2.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[u_xlati1].zzz + u_xlat2.xyz;
					    u_xlat2.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[u_xlati1].www + u_xlat2.xyz;
					    u_xlat2.x = dot(u_xlat2.xyz, u_xlat5.xyz);
					    u_xlat3.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].yyy;
					    u_xlat3.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati1 + 1)].www + u_xlat3.xyz;
					    u_xlat2.y = dot(u_xlat3.xyz, u_xlat5.xyz);
					    u_xlat3.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].yyy;
					    u_xlat3.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati1 + 2)].www + u_xlat3.xyz;
					    u_xlat2.z = dot(u_xlat3.xyz, u_xlat5.xyz);
					    u_xlat5.x = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat5.x = inversesqrt(u_xlat5.x);
					    vs_TEXCOORD1.xyz = u_xlat5.xxx * u_xlat2.xyz;
					    u_xlat4 = u_xlat0.y * unity_StereoMatrixV[(u_xlati1 + 1)].z;
					    u_xlat0.x = unity_StereoMatrixV[u_xlati1].z * u_xlat0.x + u_xlat4;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati1 + 2)].z * u_xlat0.z + u_xlat0.x;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati1 + 3)].z * u_xlat0.w + u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
					    vs_TEXCOORD1.w = (-u_xlat0.x);
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat27 = dot(u_xlat1.xyz, vec3(1.0, 1.0, 1.0));
					    u_xlat1.y = u_xlat27 + in_COLOR0.x;
					    u_xlat27 = u_xlat1.y + in_COLOR0.y;
					    u_xlat19 = -abs(in_TANGENT0.w) + 1.0;
					    u_xlati28 = unity_StereoEyeIndex << 2;
					    u_xlat2 = unity_WorldToObject[1] * unity_StereoMatrixInvV[(u_xlati28 + 1)].yyyy;
					    u_xlat2 = unity_WorldToObject[0] * unity_StereoMatrixInvV[(u_xlati28 + 1)].xxxx + u_xlat2;
					    u_xlat2 = unity_WorldToObject[2] * unity_StereoMatrixInvV[(u_xlati28 + 1)].zzzz + u_xlat2;
					    u_xlat2 = unity_WorldToObject[3] * unity_StereoMatrixInvV[(u_xlati28 + 1)].wwww + u_xlat2;
					    u_xlat3 = u_xlat2 * in_NORMAL0.yyyy;
					    u_xlat4 = unity_WorldToObject[1] * unity_StereoMatrixInvV[u_xlati28].yyyy;
					    u_xlat4 = unity_WorldToObject[0] * unity_StereoMatrixInvV[u_xlati28].xxxx + u_xlat4;
					    u_xlat4 = unity_WorldToObject[2] * unity_StereoMatrixInvV[u_xlati28].zzzz + u_xlat4;
					    u_xlat4 = unity_WorldToObject[3] * unity_StereoMatrixInvV[u_xlati28].wwww + u_xlat4;
					    u_xlat3 = in_NORMAL0.xxxx * u_xlat4 + u_xlat3;
					    u_xlat5.xyz = u_xlat3.xyz * vec3(u_xlat19) + in_POSITION0.xyz;
					    u_xlat5.xyz = u_xlat5.xyz * _TreeInstanceScale.xyz;
					    u_xlat1.x = dot(u_xlat5.xyz, vec3(u_xlat27));
					    ...
					    u_xlat7.y = u_xlat0.y * in_TEXCOORD1.y;
					    u_xlat8 = unity_WorldToObject[1] * unity_StereoMatrixInvV[(u_xlati28 + 2)].yyyy;
					    u_xlat8 = unity_WorldToObject[0] * unity_StereoMatrixInvV[(u_xlati28 + 2)].xxxx + u_xlat8;
					    u_xlat8 = unity_WorldToObject[2] * unity_StereoMatrixInvV[(u_xlati28 + 2)].zzzz + u_xlat8;
					    u_xlat8 = unity_WorldToObject[3] * unity_StereoMatrixInvV[(u_xlati28 + 2)].wwww + u_xlat8;
					    u_xlat3 = in_NORMAL0.zzzz * u_xlat8 + u_xlat3;
					    u_xlat9 = dot(u_xlat3, u_xlat3);
					    u_xlat9 = inversesqrt(u_xlat9);
					    u_xlat3.xyz = u_xlat3.xyz * vec3(u_xlat9) + (-in_NORMAL0.xyz);
					    u_xlat1.xyz = vec3(u_xlat19) * u_xlat3.xyz + in_NORMAL0.xyz;
					    u_xlat9 = in_COLOR0.y * 0.100000001;
					    u_xlat7.xz = u_xlat1.xz * vec2(u_xlat9);
					    u_xlat0.xyz = u_xlat0.xzx * u_xlat7.xyz + u_xlat6.xyz;
					    ...
					    u_xlat0 = u_xlat0 + unity_ObjectToWorld[3];
					    u_xlat3 = u_xlat0.yyyy * unity_StereoMatrixVP[(u_xlati28 + 1)];
					    u_xlat3 = unity_StereoMatrixVP[u_xlati28] * u_xlat0.xxxx + u_xlat3;
					    u_xlat3 = unity_StereoMatrixVP[(u_xlati28 + 2)] * u_xlat0.zzzz + u_xlat3;
					    gl_Position = unity_StereoMatrixVP[(u_xlati28 + 3)] * u_xlat0.wwww + u_xlat3;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
					    u_xlat9 = u_xlat0.y * unity_StereoMatrixV[(u_xlati28 + 1)].z;
					    u_xlat0.x = unity_StereoMatrixV[u_xlati28].z * u_xlat0.x + u_xlat9;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati28 + 2)].z * u_xlat0.z + u_xlat0.x;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati28 + 3)].z * u_xlat0.w + u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
					    vs_TEXCOORD1.w = (-u_xlat0.x);
					    ...
					    u_xlat1.z = dot(u_xlat8.xyz, u_xlat0.xyz);
					    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat2 = unity_StereoMatrixVP[(u_xlati1 + 2)] * u_xlat0.zzzz + u_xlat2;
					    gl_Position = unity_StereoMatrixVP[(u_xlati1 + 3)] * u_xlat0.wwww + u_xlat2;
					    u_xlatb4 = 0.0<in_TEXCOORD0.y;
					    vs_TEXCOORD0.y = u_xlatb4 ? 1.0 : float(0.0);
					    vs_TEXCOORD0.x = in_TEXCOORD0.x;
					    u_xlat3 = u_xlat0.y * unity_StereoMatrixV[(u_xlati1 + 1)].z;
					    u_xlat0.x = unity_StereoMatrixV[u_xlati1].z * u_xlat0.x + u_xlat3;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati1 + 2)].z * u_xlat0.z + u_xlat0.x;
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = vec3(u_xlat12) * u_xlat2.xyz + vec3(0.5, 0.5, 0.5);
					    u_xlat4.xyz = u_xlat4.xyz + u_xlat4.xyz;
					    vs_COLOR0.xyz = u_xlat4.xyz * in_COLOR0.xyz;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
					    u_xlat4.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[u_xlati0].yyy;
					    u_xlat4.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[u_xlati0].xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[u_xlati0].zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[u_xlati0].www + u_xlat4.xyz;
					    u_xlat2.x = dot(u_xlat4.xyz, in_NORMAL0.xyz);
					    u_xlat4.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati0 + 1)].yyy;
					    u_xlat4.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati0 + 1)].xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati0 + 1)].zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati0 + 1)].www + u_xlat4.xyz;
					    u_xlat2.y = dot(u_xlat4.xyz, in_NORMAL0.xyz);
					    u_xlat4.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati0 + 2)].yyy;
					    u_xlat4.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati0 + 2)].xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati0 + 2)].zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati0 + 2)].www + u_xlat4.xyz;
					    u_xlat2.z = dot(u_xlat4.xyz, in_NORMAL0.xyz);
					    u_xlat4.x = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat4.x = inversesqrt(u_xlat4.x);
					    vs_TEXCOORD1.xyz = u_xlat4.xxx * u_xlat2.xyz;
					    u_xlat4.x = u_xlat1.y * unity_StereoMatrixV[(u_xlati0 + 1)].z;
					    u_xlat4.x = unity_StereoMatrixV[u_xlati0].z * u_xlat1.x + u_xlat4.x;
					    u_xlat4.x = unity_StereoMatrixV[(u_xlati0 + 2)].z * u_xlat1.z + u_xlat4.x;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati0 + 3)].z * u_xlat1.w + u_xlat4.x;
					    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
					    vs_TEXCOORD1.w = (-u_xlat0.x);
					    return;
					}"
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlati4 = unity_StereoEyeIndex << 2;
					    u_xlat3 = u_xlat2.yyyy * unity_StereoMatrixVP[(u_xlati4 + 1)];
					    u_xlat3 = unity_StereoMatrixVP[u_xlati4] * u_xlat2.xxxx + u_xlat3;
					    u_xlat3 = unity_StereoMatrixVP[(u_xlati4 + 2)] * u_xlat2.zzzz + u_xlat3;
					    gl_Position = unity_StereoMatrixVP[(u_xlati4 + 3)] * u_xlat2.wwww + u_xlat3;
					    u_xlat1.y = in_POSITION0.y;
					    ...
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
					    u_xlat0.xzw = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[u_xlati4].yyy;
					    u_xlat0.xzw = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[u_xlati4].xxx + u_xlat0.xzw;
					    u_xlat0.xzw = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[u_xlati4].zzz + u_xlat0.xzw;
					    u_xlat0.xzw = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[u_xlati4].www + u_xlat0.xzw;
					    u_xlat1.x = dot(u_xlat0.xzw, in_NORMAL0.xyz);
					    u_xlat0.xzw = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati4 + 1)].yyy;
					    u_xlat0.xzw = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati4 + 1)].xxx + u_xlat0.xzw;
					    u_xlat0.xzw = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati4 + 1)].zzz + u_xlat0.xzw;
					    u_xlat0.xzw = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati4 + 1)].www + u_xlat0.xzw;
					    u_xlat1.y = dot(u_xlat0.xzw, in_NORMAL0.xyz);
					    u_xlat0.xzw = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati4 + 2)].yyy;
					    u_xlat0.xzw = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati4 + 2)].xxx + u_xlat0.xzw;
					    u_xlat0.xzw = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati4 + 2)].zzz + u_xlat0.xzw;
					    u_xlat0.xzw = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati4 + 2)].www + u_xlat0.xzw;
					    u_xlat1.z = dot(u_xlat0.xzw, in_NORMAL0.xyz);
					    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    vs_TEXCOORD1.xyz = u_xlat0.xxx * u_xlat1.xyz;
					    u_xlat0.x = u_xlat2.y * unity_StereoMatrixV[(u_xlati4 + 1)].z;
					    u_xlat0.x = unity_StereoMatrixV[u_xlati4].z * u_xlat2.x + u_xlat0.x;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati4 + 2)].z * u_xlat2.z + u_xlat0.x;
					    u_xlat0.x = unity_StereoMatrixV[(u_xlati4 + 3)].z * u_xlat2.w + u_xlat0.x;
					    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
					    vs_TEXCOORD1.w = (-u_xlat0.x);
					    return;
					}"
