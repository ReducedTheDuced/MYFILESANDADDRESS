...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					layout(std140) uniform UnityStereoGlobals {
						...
						vec4 unused_2_2[12];
						mat4x4 unity_StereoCameraInvProjection;
						vec4 unused_2_4[24];
					};
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = u_xlat4.xxx * unity_StereoCameraInvProjection[(u_xlati1 + 1)].xyz;
					    u_xlat4.xyz = unity_StereoCameraInvProjection[u_xlati1].xyz * u_xlat0.xxx + u_xlat4.xyz;
					    gl_Position = u_xlat0;
					    u_xlat0.xyz = u_xlat4.xyz + (-unity_StereoCameraInvProjection[(u_xlati1 + 2)].xyz);
					    u_xlat4.xyz = u_xlat4.xyz + unity_StereoCameraInvProjection[(u_xlati1 + 2)].xyz;
					    u_xlat2.xyz = u_xlat4.xyz + unity_StereoCameraInvProjection[(u_xlati1 + 3)].xyz;
					    u_xlat0.xyz = u_xlat0.xyz + unity_StereoCameraInvProjection[(u_xlati1 + 3)].xyz;
					    u_xlat0.w = (-u_xlat0.z);
					    vs_TEXCOORD2.xyz = u_xlat0.xyw;
					    u_xlat2.w = (-u_xlat2.z);
...
SubProgram "d3d11 " {
Keywords { "SHADOWS_SPLIT_SPHERES" "SHADOWS_SINGLE_CASCADE" "UNITY_SINGLE_PASS_STEREO" }
					"vs_4_0
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					layout(std140) uniform UnityStereoGlobals {
						vec4 unused_2_0[56];
						mat4x4 unity_StereoCameraToWorld;
						vec4 unused_2_2[8];
					};
					layout(std140) uniform UnityStereoEyeIndex {
						int unity_StereoEyeIndex;
					...
					;
					    ...
					    u_xlat2 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati12 + 1)];
					    u_xlat2 = unity_StereoCameraToWorld[u_xlati12] * u_xlat0.xxxx + u_xlat2;
					    u_xlat2 = unity_StereoCameraToWorld[(u_xlati12 + 2)] * u_xlat0.zzzz + u_xlat2;
					    u_xlat0.x = u_xlat0.z * _LightShadowData.z + _LightShadowData.w;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat2 = u_xlat2 + unity_StereoCameraToWorld[(u_xlati12 + 3)];
					    u_xlat4.xyz = u_xlat2.yyy * unused_1_4[1].xyz;
					    u_xlat4.xyz = unused_1_4[0].xyz * u_xlat2.xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unused_1_4[2].xyz * u_xlat2.zzz + u_xlat4.xyz;
					    u_xlat4.xyz = unused_1_4[3].xyz * u_xlat2.www + u_xlat4.xyz;
					    u_xlat4.xyz = u_xlat1.yyy * u_xlat4.xyz;
					    u_xlat3.xyz = u_xlat2.yyy * unity_WorldToShadow[1].xyz;
					    u_xlat3.xyz = unity_WorldToShadow[0].xyz * u_xlat2.xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToShadow[2].xyz * u_xlat2.zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToShadow[3].xyz * u_xlat2.www + u_xlat3.xyz;
					    u_xlat4.xyz = u_xlat3.xyz * u_xlat1.xxx + u_xlat4.xyz;
					    u_xlat3.xyz = u_xlat2.yyy * unused_1_4[5].xyz;
					    u_xlat3.xyz = unused_1_4[4].xyz * u_xlat2.xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unused_1_4[6].xyz * u_xlat2.zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unused_1_4[7].xyz * u_xlat2.www + u_xlat3.xyz;
					    u_xlat4.xyz = u_xlat3.xyz * u_xlat1.zzz + u_xlat4.xyz;
					    u_xlat1.xyz = u_xlat2.yyy * unused_1_4[9].xyz;
					    u_xlat1.xyz = unused_1_4[8].xyz * u_xlat2.xxx + u_xlat1.xyz;
					    u_xlat1.xyz = unused_1_4[10].xyz * u_xlat2.zzz + u_xlat1.xyz;
					    u_xlat1.xyz = unused_1_4[11].xyz * u_xlat2.www + u_xlat1.xyz;
					    u_xlat4.xyz = u_xlat1.xyz * u_xlat1.www + u_xlat4.xyz;
					    vec3 txVec0 = vec3(u_xlat4.xy,u_xlat4.z);
					    u_xlat4.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec0, 0.0);
					    u_xlat8 = (-_LightShadowData.x) + 1.0;
...
Keywords { "SHADOWS_SPLIT_SPHERES" "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = unity_OrthoParams.www * u_xlat0.xzw + u_xlat1.xyz;
					    u_xlati12 = unity_StereoEyeIndex << 2;
					    u_xlat1 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati12 + 1)];
					    u_xlat1 = unity_StereoCameraToWorld[u_xlati12] * u_xlat0.xxxx + u_xlat1;
					    u_xlat1 = unity_StereoCameraToWorld[(u_xlati12 + 2)] * u_xlat0.zzzz + u_xlat1;
					    u_xlat0 = u_xlat1 + unity_StereoCameraToWorld[(u_xlati12 + 3)];
					    u_xlat1.xyz = u_xlat0.xyz + (-unity_ShadowSplitSpheres.xyz);
					    u_xlat1.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat2.xyz = u_xlat0.xyz + (-unused_1_1[0].xyz);
					    u_xlat1.y = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat2.xyz = u_xlat0.xyz + (-unused_1_1[1].xyz);
					    u_xlat1.z = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat2.xyz = u_xlat0.xyz + (-unused_1_1[2].xyz);
					    u_xlat1.w = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlatb1 = lessThan(u_xlat1, unity_ShadowSplitSqRadii);
					    u_xlat2.x = (u_xlatb1.x) ? float(-1.0) : float(-0.0);
					    u_xlat2.y = (u_xlatb1.y) ? float(-1.0) : float(-0.0);
					...
					;
					    u_xlat5.xyz = u_xlat2.xyz + u_xlat1.yzw;
					    u_xlat5.xyz = max(u_xlat5.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlat2.xyz = u_xlat0.yyy * unused_1_5[1].xyz;
					    u_xlat2.xyz = unused_1_5[0].xyz * u_xlat0.xxx + u_xlat2.xyz;
					    u_xlat2.xyz = unused_1_5[2].xyz * u_xlat0.zzz + u_xlat2.xyz;
					    u_xlat2.xyz = unused_1_5[3].xyz * u_xlat0.www + u_xlat2.xyz;
					    u_xlat2.xyz = u_xlat5.xxx * u_xlat2.xyz;
					    u_xlat3.xyz = u_xlat0.yyy * unity_WorldToShadow[1].xyz;
					    u_xlat3.xyz = unity_WorldToShadow[0].xyz * u_xlat0.xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToShadow[2].xyz * u_xlat0.zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToShadow[3].xyz * u_xlat0.www + u_xlat3.xyz;
					    u_xlat2.xyz = u_xlat3.xyz * u_xlat1.xxx + u_xlat2.xyz;
					    u_xlat3.xyz = u_xlat0.yyy * unused_1_5[5].xyz;
					    u_xlat3.xyz = unused_1_5[4].xyz * u_xlat0.xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unused_1_5[6].xyz * u_xlat0.zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unused_1_5[7].xyz * u_xlat0.www + u_xlat3.xyz;
					    u_xlat1.xyz = u_xlat3.xyz * u_xlat5.yyy + u_xlat2.xyz;
					    u_xlat2.xyz = u_xlat0.yyy * unused_1_5[9].xyz;
					    u_xlat2.xyz = unused_1_5[8].xyz * u_xlat0.xxx + u_xlat2.xyz;
					    u_xlat2.xyz = unused_1_5[10].xyz * u_xlat0.zzz + u_xlat2.xyz;
					    u_xlat2.xyz = unused_1_5[11].xyz * u_xlat0.www + u_xlat2.xyz;
					    u_xlat0.xyz = u_xlat0.xyz + (-unity_ShadowFadeCenterAndType.xyz);
					    u_xlat0.x = dot(u_xlat0.xyz, u_xlat0.xyz);
					    u_xlat0.x = sqrt(u_xlat0.x);
					    u_xlat0.x = u_xlat0.x * _LightShadowData.z + _LightShadowData.w;
...
Keywords { "SHADOWS_SINGLE_CASCADE" "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat1 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati6 + 1)];
					    u_xlat1 = unity_StereoCameraToWorld[u_xlati6] * u_xlat0.xxxx + u_xlat1;
					    u_xlat1 = unity_StereoCameraToWorld[(u_xlati6 + 2)] * u_xlat0.zzzz + u_xlat1;
					    u_xlat0.x = u_xlat0.z * _LightShadowData.z + _LightShadowData.w;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat1 = u_xlat1 + unity_StereoCameraToWorld[(u_xlati6 + 3)];
					    u_xlat2.xyz = u_xlat1.yyy * unity_WorldToShadow[1].xyz;
					    u_xlat2.xyz = unity_WorldToShadow[0].xyz * u_xlat1.xxx + u_xlat2.xyz;
					    u_xlat2.xyz = unity_WorldToShadow[2].xyz * u_xlat1.zzz + u_xlat2.xyz;
					    u_xlat2.xyz = unity_WorldToShadow[3].xyz * u_xlat1.www + u_xlat2.xyz;
...
Keywords { "SHADOWS_SPLIT_SPHERES" "SHADOWS_SINGLE_CASCADE" "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat1 = unity_StereoCameraToWorld[u_xlati6] * u_xlat0.xxxx + u_xlat1;
					    u_xlat1 = unity_StereoCameraToWorld[(u_xlati6 + 2)] * u_xlat0.zzzz + u_xlat1;
					    u_xlat0 = u_xlat1 + unity_StereoCameraToWorld[(u_xlati6 + 3)];
					    u_xlat1.xyz = u_xlat0.yyy * unity_WorldToShadow[1].xyz;
					    u_xlat1.xyz = unity_WorldToShadow[0].xyz * u_xlat0.xxx + u_xlat1.xyz;
					    u_xlat1.xyz = unity_WorldToShadow[2].xyz * u_xlat0.zzz + u_xlat1.xyz;
					    u_xlat1.xyz = unity_WorldToShadow[3].xyz * u_xlat0.www + u_xlat1.xyz;
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					;
					    ...
					    u_xlat2 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati24 + 1)];
					    u_xlat2 = unity_StereoCameraToWorld[u_xlati24] * u_xlat0.xxxx + u_xlat2;
					    u_xlat2 = unity_StereoCameraToWorld[(u_xlati24 + 2)] * u_xlat0.zzzz + u_xlat2;
					    u_xlat0.x = u_xlat0.z * _LightShadowData.z + _LightShadowData.w;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat2 = u_xlat2 + unity_StereoCameraToWorld[(u_xlati24 + 3)];
					    u_xlat8.xyz = u_xlat2.yyy * unused_2_4[1].xyz;
					    u_xlat8.xyz = unused_2_4[0].xyz * u_xlat2.xxx + u_xlat8.xyz;
					    u_xlat8.xyz = unused_2_4[2].xyz * u_xlat2.zzz + u_xlat8.xyz;
					    u_xlat8.xyz = unused_2_4[3].xyz * u_xlat2.www + u_xlat8.xyz;
					    u_xlat8.xyz = u_xlat1.yyy * u_xlat8.xyz;
					    u_xlat3.xyz = u_xlat2.yyy * unity_WorldToShadow[1].xyz;
					    u_xlat3.xyz = unity_WorldToShadow[0].xyz * u_xlat2.xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToShadow[2].xyz * u_xlat2.zzz + u_xlat3.xyz;
...
Keywords { "SHADOWS_SPLIT_SPHERES" "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = unity_OrthoParams.www * u_xlat0.xzw + u_xlat1.xyz;
					    u_xlati24 = unity_StereoEyeIndex << 2;
					    u_xlat1 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati24 + 1)];
					    u_xlat1 = unity_StereoCameraToWorld[u_xlati24] * u_xlat0.xxxx + u_xlat1;
					    u_xlat1 = unity_StereoCameraToWorld[(u_xlati24 + 2)] * u_xlat0.zzzz + u_xlat1;
					    u_xlat0 = u_xlat1 + unity_StereoCameraToWorld[(u_xlati24 + 3)];
					    u_xlat1.xyz = u_xlat0.xyz + (-unity_ShadowSplitSpheres.xyz);
					    u_xlat1.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat2.xyz = u_xlat0.xyz + (-unused_2_1[0].xyz);
					    u_xlat1.y = dot(u_xlat2.xyz, u_xlat2.xyz);
...
Keywords { "SHADOWS_SINGLE_CASCADE" "UNITY_SINGLE_PASS_STEREO" }
					...
					{
					    u_xlat0 = texture(_CameraDepthTexture, vs_TEXCOORD0.xy);
					    u_xlat7.x = _ZBufferParams.x * u_xlat0.x + _ZBufferParams.y;
					    u_xlat7.x = float(1.0) / u_xlat7.x;
					    u_xlat14 = (-u_xlat7.x) + u_xlat0.x;
					    u_xlat7.x = unity_OrthoParams.w * u_xlat14 + u_xlat7.x;
					    u_xlat1.xyz = (-vs_TEXCOORD2.xyz) + vs_TEXCOORD3.xyz;
					    u_xlat0.xzw = u_xlat0.xxx * u_xlat1.xyz + vs_TEXCOORD2.xyz;
					    u_xlat0.xzw = (-vs_TEXCOORD1.xyz) * u_xlat7.xxx + u_xlat0.xzw;
					    u_xlat1.xyz = u_xlat7.xxx * vs_TEXCOORD1.xyz;
					    u_xlat0.xyz = unity_OrthoParams.www * u_xlat0.xzw + u_xlat1.xyz;
					    u_xlati21 = unity_StereoEyeIndex << 2;
					    u_xlat1 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati21 + 1)];
					    u_xlat1 = unity_StereoCameraToWorld[u_xlati21] * u_xlat0.xxxx + u_xlat1;
					    u_xlat1 = unity_StereoCameraToWorld[(u_xlati21 + 2)] * u_xlat0.zzzz + u_xlat1;
					    u_xlat0.x = u_xlat0.z * _LightShadowData.z + _LightShadowData.w;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat1 = u_xlat1 + unity_StereoCameraToWorld[(u_xlati21 + 3)];
					    u_xlat7.xyz = u_xlat1.yyy * unity_WorldToShadow[1].xyz;
					    u_xlat7.xyz = unity_WorldToShadow[0].xyz * u_xlat1.xxx + u_xlat7.xyz;
					    u_xlat7.xyz = unity_WorldToShadow[2].xyz * u_xlat1.zzz + u_xlat7.xyz;
					    u_xlat7.xyz = unity_WorldToShadow[3].xyz * u_xlat1.www + u_xlat7.xyz;
					    u_xlat1.xz = _ShadowMapTexture_TexelSize.yy;
					    u_xlat1.y = 0.142857149;
					    u_xlat7.xy = u_xlat7.xy * _ShadowMapTexture_TexelSize.zw + vec2(0.5, 0.5);
					    ...
					    u_xlat6.xz = vec2(u_xlat22) * vec2(-1.0, 1.0) + vec2(4.0, 1.0);
					    ...
					    u_xlat4 = u_xlat7.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.ywxw;
					    u_xlat2.xy = u_xlat7.xy * _ShadowMapTexture_TexelSize.xy + u_xlat5.zw;
					    vec3 txVec0 = vec3(u_xlat2.xy,u_xlat7.z);
					    u_xlat1.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec0, 0.0);
					    vec3 txVec1 = vec3(u_xlat4.xy,u_xlat7.z);
					    u_xlat2.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec1, 0.0);
					    vec3 txVec2 = vec3(u_xlat4.zw,u_xlat7.z);
					    u_xlat9.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec2, 0.0);
					    u_xlat6.y = 7.0;
					    u_xlat3.xyz = u_xlat3.yyy * u_xlat6.xyz;
					    u_xlat4.xyz = u_xlat16.yyy * u_xlat6.xyz;
					    u_xlat16.xy = u_xlat6.xz * vec2(7.0, 7.0);
					    u_xlat9.x = u_xlat9.x * u_xlat3.y;
					    u_xlat2.x = u_xlat3.x * u_xlat2.x + u_xlat9.x;
					    u_xlat1.x = u_xlat3.z * u_xlat1.x + u_xlat2.x;
					    u_xlat1.w = u_xlat5.y;
					    u_xlat3 = u_xlat7.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat1.wywz;
					    u_xlat5.yw = u_xlat1.yz;
					    vec3 txVec3 = vec3(u_xlat3.xy,u_xlat7.z);
					    u_xlat8 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec3, 0.0);
					    vec3 txVec4 = vec3(u_xlat3.zw,u_xlat7.z);
					    u_xlat15 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec4, 0.0);
					    u_xlat1.x = u_xlat16.x * u_xlat8 + u_xlat1.x;
					    u_xlat3 = u_xlat7.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.xyzy;
					    u_xlat5 = u_xlat7.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.xwzw;
					    vec3 txVec5 = vec3(u_xlat3.xy,u_xlat7.z);
					    u_xlat7.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec5, 0.0);
					    vec3 txVec6 = vec3(u_xlat3.zw,u_xlat7.z);
					    u_xlat14 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec6, 0.0);
					    u_xlat7.x = u_xlat7.x * 49.0 + u_xlat1.x;
					    u_xlat7.x = u_xlat16.y * u_xlat14 + u_xlat7.x;
					    u_xlat7.x = u_xlat4.x * u_xlat15 + u_xlat7.x;
					    vec3 txVec7 = vec3(u_xlat5.xy,u_xlat7.z);
					    u_xlat14 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec7, 0.0);
					    vec3 txVec8 = vec3(u_xlat5.zw,u_xlat7.z);
					    u_xlat21 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec8, 0.0);
					    u_xlat7.x = u_xlat4.y * u_xlat14 + u_xlat7.x;
					    u_xlat7.x = u_xlat4.z * u_xlat21 + u_xlat7.x;
					    u_xlat7.x = u_xlat7.x * 0.0069444445;
					    u_xlat14 = (-_LightShadowData.x) + 1.0;
					    u_xlat7.x = u_xlat7.x * u_xlat14 + _LightShadowData.x;
					    SV_Target0 = u_xlat0.xxxx + u_xlat7.xxxx;
					    return;
					}"
}
SubProgram "d3d9 " {
...
Keywords { "SHADOWS_SPLIT_SPHERES" "SHADOWS_SINGLE_CASCADE" "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat0.x = u_xlat0.x * _LightShadowData.z + _LightShadowData.w;
					    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
					    u_xlat2.xz = _ShadowMapTexture_TexelSize.yy;
					    u_xlat2.y = 0.142857149;
					    u_xlat8.xy = u_xlat1.xy * _ShadowMapTexture_TexelSize.zw + vec2(0.5, 0.5);
					    u_xlat1.xy = fract(u_xlat8.xy);
					    u_xlat8.xy = floor(u_xlat8.xy);
					    u_xlat8.xy = u_xlat8.xy + vec2(-0.5, -0.5);
					    u_xlat3.xy = (-u_xlat1.xy) * vec2(2.0, 2.0) + vec2(3.0, 3.0);
					    u_xlat19.xy = (-u_xlat1.xy) * vec2(3.0, 3.0) + vec2(4.0, 4.0);
					    u_xlat3.xy = u_xlat3.xy / u_xlat19.xy;
					    u_xlat4.xy = u_xlat3.xy + vec2(-2.0, -2.0);
					    u_xlat5.z = u_xlat4.y;
					    u_xlat3.xy = u_xlat1.xy * vec2(3.0, 3.0) + vec2(1.0, 1.0);
					    u_xlat3.xz = u_xlat1.xy / u_xlat3.xy;
					    u_xlat5.xw = u_xlat3.xz + vec2(2.0, 2.0);
					    u_xlat4.w = u_xlat5.x;
					    u_xlat9.xz = u_xlat1.xy + vec2(3.0, 3.0);
					    u_xlat24 = u_xlat1.x * 3.0;
					    u_xlat6.xz = vec2(u_xlat24) * vec2(-1.0, 1.0) + vec2(4.0, 1.0);
					    u_xlat5.xy = u_xlat9.xz * _ShadowMapTexture_TexelSize.xy;
					    u_xlat2.xyz = u_xlat2.xyz * u_xlat5.zyw;
					    u_xlat4.z = u_xlat5.x;
					    u_xlat5.w = u_xlat2.x;
					    u_xlat7.xz = _ShadowMapTexture_TexelSize.xx;
					    u_xlat7.y = 0.142857149;
					    u_xlat5.xyz = u_xlat4.zxw * u_xlat7.yxz;
					    u_xlat4 = u_xlat8.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.ywxw;
					    u_xlat1.xy = u_xlat8.xy * _ShadowMapTexture_TexelSize.xy + u_xlat5.zw;
					    vec3 txVec0 = vec3(u_xlat1.xy,u_xlat1.z);
					    ...
					    u_xlat9.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec2, 0.0);
					    u_xlat6.y = 7.0;
					    u_xlat3.xzw = u_xlat19.yyy * u_xlat6.xyz;
					    u_xlat4.xyz = u_xlat3.yyy * u_xlat6.xyz;
					    u_xlat6.xy = u_xlat6.xz * vec2(7.0, 7.0);
					    u_xlat9.x = u_xlat9.x * u_xlat3.z;
					    u_xlat1.x = u_xlat3.x * u_xlat1.x + u_xlat9.x;
					    u_xlat24 = u_xlat3.w * u_xlat24 + u_xlat1.x;
					    u_xlat2.w = u_xlat5.y;
					    u_xlat3 = u_xlat8.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat2.wywz;
					    u_xlat5.yw = u_xlat2.yz;
					    vec3 txVec3 = vec3(u_xlat3.xy,u_xlat1.z);
					    u_xlat1.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec3, 0.0);
					    vec3 txVec4 = vec3(u_xlat3.zw,u_xlat1.z);
					    u_xlat9.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec4, 0.0);
					    u_xlat24 = u_xlat6.x * u_xlat1.x + u_xlat24;
					    u_xlat2 = u_xlat8.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.xyzy;
					    u_xlat3 = u_xlat8.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat5.xwzw;
					    vec3 txVec5 = vec3(u_xlat2.xy,u_xlat1.z);
					    u_xlat8.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec5, 0.0);
					    vec3 txVec6 = vec3(u_xlat2.zw,u_xlat1.z);
					    u_xlat16 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec6, 0.0);
					    u_xlat8.x = u_xlat8.x * 49.0 + u_xlat24;
					    u_xlat8.x = u_xlat6.y * u_xlat16 + u_xlat8.x;
					    u_xlat8.x = u_xlat4.x * u_xlat9.x + u_xlat8.x;
					    vec3 txVec7 = vec3(u_xlat3.xy,u_xlat1.z);
					    u_xlat16 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec7, 0.0);
					    vec3 txVec8 = vec3(u_xlat3.zw,u_xlat1.z);
					    u_xlat24 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec8, 0.0);
					    u_xlat8.x = u_xlat4.y * u_xlat16 + u_xlat8.x;
					    u_xlat8.x = u_xlat4.z * u_xlat24 + u_xlat8.x;
					    u_xlat8.x = u_xlat8.x * 0.0069444445;
					    u_xlat16 = (-_LightShadowData.x) + 1.0;
					    u_xlat8.x = u_xlat8.x * u_xlat16 + _LightShadowData.x;
					    SV_Target0 = u_xlat0.xxxx + u_xlat8.xxxx;
