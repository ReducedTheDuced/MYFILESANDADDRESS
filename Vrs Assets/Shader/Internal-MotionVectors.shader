...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    vs_TEXCOORD0.xy = u_xlat0.xy * unity_StereoScaleOffset.xy + u_xlat1.xy;
					    vs_TEXCOORD1.xyz = in_NORMAL0.xyz;
					    return;
					}"
}
...
Keywords { "UNITY_SINGLE_PASS_STEREO" }
					...
					void main()
					{
					    ...
					    u_xlat1 = u_xlat0.yyyy * unity_StereoCameraToWorld[(u_xlati9 + 1)];
					    u_xlat1 = unity_StereoCameraToWorld[u_xlati9] * u_xlat0.xxxx + u_xlat1;
					    u_xlat1 = unity_StereoCameraToWorld[(u_xlati9 + 2)] * u_xlat0.zzzz + u_xlat1;
					    u_xlat0 = u_xlat1 + unity_StereoCameraToWorld[(u_xlati9 + 3)];
					    u_xlat1.xyz = u_xlat0.yyy * _PreviousVP[1].xyw;
					    u_xlat1.xyz = _PreviousVP[0].xyw * u_xlat0.xxx + u_xlat1.xyz;
					    u_xlat1.xyz = _PreviousVP[2].xyw * u_xlat0.zzz + u_xlat1.xyz;
					    u_xlat1.xyz = _PreviousVP[3].xyw * u_xlat0.www + u_xlat1.xyz;
